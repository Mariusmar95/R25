...
import { FirstHomePageSectionProps } from "../../types/types";

function FirstHomePageSection({
  imageSrc1,
  altText1,
  imageSrc2,
  altText2,
}: FirstHomePageSectionProps) {
  return (
    <section className="relative mt-10 md:mt-6 mb-10 md:mb-6 lg:py-32">
      <div className="relative justify-items-center items-center gap-28 lg:gap-24 grid lg:grid-cols-2 mx-auto px-6 md:px-8 max-w-7xl max-h-2xl">
        {/*Images*/}
        ...
        <div className="space-y-8 w-full max-w-2xl animate-fadeIn">
          ...
          <div className="pt-4">
            <Link
              to="/about"
              className="inline-flex items-center gap-3 bg-gradient-to-r from-cyan-500 hover:from-cyan-600 to-blue-600 hover:to-blue-700 shadow-lg hover:shadow-xl px-8 py-4 border hover:border-white/20 border-transparent rounded-2xl font-semibold text-white transition-all hover:-translate-y-1 duration-300 transform"
            >
